package com.dexinkeji.cn.aakefudan.chat;
...
import com.dexinkeji.cn.aakefudan.adapter.XiuliAdapter;
...
import com.dexinkeji.cn.util.NavigationUtils;
                ...
                switch (position) {
                    case 0:
                        try {
                            ...
                            com.dexinkeji.cn.app.UIHelper.ToastMessage(MyApplication.getApp().getApplicationContext(), "请下载高德地图后重新尝试", Toast.LENGTH_SHORT);
                        }
                        break;
                    case 1:
                        try {
                            ...
                            com.dexinkeji.cn.app.UIHelper.ToastMessage(MyApplication.getApp().getApplicationContext(), "请下载百度地图后重新尝试", Toast.LENGTH_SHORT);
                        }
