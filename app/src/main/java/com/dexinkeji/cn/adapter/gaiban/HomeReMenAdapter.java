...
import com.dexinkeji.cn.view.CornerTransform;

import java.util.List;

public class HomeReMenAdapter extends BaseQuickAdapter<Home.DataBean.IndexShowListBean, com.dexinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseViewHolder> {
    public HomeReMenAdapter(int layoutResId, @Nullable List<Home.DataBean.IndexShowListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(com.dexinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseViewHolder helper, Home.DataBean.IndexShowListBean item) {
