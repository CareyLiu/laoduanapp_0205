...
import com.dexinkeji.cn.adapter.ShangJiaNearbyAdapter;
import com.dexinkeji.cn.adapter.tuangou.TuanGouShangJiaDetailsAdapter;
import com.dexinkeji.cn.adapter.tuangou.TuanGouShangJiaHighScoreList1Adapter;
...
import com.dexinkeji.cn.config.GlideImageLoader;
...
import static com.dexinkeji.cn.get_net.Urls.LIBAOLIST;
...
public class TuanGouShangJiaDetailsActivity extends AbStracTuanGouShangJiaDetails {
    ...
    public void setFotter() {
        ...
        shangJiaNearbyAdapter.setOnItemChildClickListener(new com.dexinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter.OnItemChildClickListener() {
            @Override
            public void onItemChildClick(com.dexinkeji.cn.baseadapter.baserecyclerviewadapterhelper.BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    /**
                     *        tvShopName.setText(storeListBean.getInst_name());
